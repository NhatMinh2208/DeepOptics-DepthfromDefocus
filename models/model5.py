...
from utils.fft import crop_psf, fftshift

DepthEstimatorOutputs = namedtuple('DepthEstimatorOutputs',
...
class DepthEstimator(nn.Module):
    ...
    def compute_loss(self, outputs, target_depthmaps, target_images, depth_conf):
        ...
        total_loss = self.__combine_loss(0, image_loss, psf_loss)
        logs = {
    ...
    def training_step(self, samples, batch_idx):
        ...
        data_loss, loss_logs = self.compute_loss(outputs, target_depthmaps, target_images, depth_conf)
